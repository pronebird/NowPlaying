...
#define JRC_ID_PLAY_RESUME			5105
...
// Note : sends WM_COPYDATA message (JRC_COPYDATA_ID_DVD_SUBTITLE)
#define JRC_ID_DVD_SUBTITLE_FLAG	7033
...
#define GET_STATUS_TRACK_LIST_EX			(21)
...
#define JRC_COPYDATA_ID_ALBUM_ADDED			(0x1005)

#define JRC_COPYDATA_ID_TRACK_CHANGED		(0x1010)	// (API v5) send automatically when track was changed (1, 2, ..)
#define JRC_COPYDATA_ID_STATUS_CHANGED		(0x1011)	// (API v5) send automatically when status was changed (Play, Pause, ...)
#define JRC_COPYDATA_ID_PLAY_MODE_CHANGED	(0x1012)	// (API v5) send automatically when mode was changed (AudioCD, VideoCD, DVD, File)
#define JRC_COPYDATA_ID_MAIN_ALBUM_CHANGED	(0x1013)	// (API v5) send automatically when album of main window was changed
...
#define JRC_COPYDATA_ID_TRACK_LIST_EX		(0x3009)	// (API v4) 

#define JRC_COPYDATA_ID_STRING				(0x9000)	// (API v4) 
