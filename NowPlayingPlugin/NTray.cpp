...
----------------------------------------------------------
Modified by Mihaylov Andrey for dynamic creation of menus
----------------------------------------------------------
*/
...
BOOL CTrayNotifyIcon::Create ( CWindow* pNotifyWnd, UINT uID, LPCTSTR pszTooltipText, HICON hIcon, UINT nNotifyMessage, HMENU pMenu )
{
 //Validate our parameters
  ATLASSERT(pNotifyWnd && pNotifyWnd->IsWindow());
#ifdef _DEBUG  
